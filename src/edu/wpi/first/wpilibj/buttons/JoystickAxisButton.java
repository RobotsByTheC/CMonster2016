 ...
 * value. A negative threshold will only be triggered when the axis is negative
 * and vice versa.
 *
...
public class JoystickAxisButton extends Button {
    ...
    /**
     * Gets whether the joystick axis is above the threshold. A negative
     * threshold will only be triggered when the axis is negative and vice
     * versa.
     * 
     * @return the state of the joystick axis button
     */
    @Override
    public boolean get() {
