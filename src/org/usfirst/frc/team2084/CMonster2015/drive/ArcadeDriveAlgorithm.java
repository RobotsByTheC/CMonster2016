 ...
 */
public class ArcadeDriveAlgorithm extends DriveAlgorithm<DriveController<WheelController<SpeedController>>> {
	 ...
	 */
	public ArcadeDriveAlgorithm(FourWheelDriveController<WheelController<SpeedController>> driveController) {
