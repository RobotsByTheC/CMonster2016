 ...
 *
 */
public class FirstRaiseToteLifterCommand extends TimedCommand {

    public FirstRaiseToteLifterCommand() {
        super(1);
    ...
    protected void initialize() {
        Robot.toteLifterSubsystem.setLifterState(LifterState.FIRST_RAISE);
    }
