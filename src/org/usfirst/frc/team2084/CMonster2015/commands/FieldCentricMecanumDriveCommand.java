...
import org.usfirst.frc.team2084.CMonster2015.drive.processors.InertiaGenerator;
...
public class FieldCentricMecanumDriveCommand extends Command {
	...
	protected void initialize() {
		rotationInertiaGenerator.reset();
	}
	...
	protected void execute() {
		...
		// more information.
		double actualRotation = scaledRotation; // rotationInertiaGenerator.process(scaledRotation,
												// timeStepper.step());
