...
public class LoggingCommand extends Command {
    ...
    private final EncoderWheelController<SpeedController> frontLeftWheel = driveController.getFrontLeftWheel();
    private final EncoderWheelController<SpeedController> frontRightWheel = driveController.getFrontRightWheel();
    private final EncoderWheelController<SpeedController> rearLeftWheel = driveController.getRearLeftWheel();
    private final EncoderWheelController<SpeedController> rearRightWheel = driveController.getRearRightWheel();
    ...
    protected void initialize() {
        // Initialize the gyro and encoders enabled state
    ...
    protected void execute() {
        ...
        // Enable or disable the gyro and encoders
        Robot.driveSubsystem.setGyroEnabled(SmartDashboard.getBoolean("Gyro Enabled", true));
