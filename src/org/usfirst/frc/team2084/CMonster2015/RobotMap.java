...
public class RobotMap {
    ...
    public static DoubleSolenoid toteLifterSubsystemSolenoid;
    ...
    public static SpeedController containerHookSubsystemJaguar;
    ...
    public static void init() {
        ...
        driveSubsystemFrontLeftEncoder.setDistancePerPulse(1.0);
        ...
        driveSubsystemFrontRightEncoder.setDistancePerPulse(1.0);
        ...
        driveSubsystemRearLeftEncoder = new Encoder(4, 5, false, EncodingType.k4X);
        LiveWindow.addSensor("Drive Subsystem", "Rear Left Encoder", driveSubsystemRearLeftEncoder);
        driveSubsystemRearLeftEncoder.setDistancePerPulse(1.0);
        ...
        driveSubsystemRearRightEncoder.setDistancePerPulse(1.0);
        driveSubsystemRearRightEncoder.setPIDSourceParameter(PIDSourceParameter.kRate);
        toteLifterSubsystemSolenoid = new DoubleSolenoid(0, 0, 1);
        LiveWindow.addActuator("Tote Lifter Subsystem", "Solenoid", toteLifterSubsystemSolenoid);
        ...
        containerHookSubsystemJaguar = new Jaguar(4);
        LiveWindow.addActuator("Container Hook Subsystem", "Jaguar", (Jaguar) containerHookSubsystemJaguar);

        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        driveSubsystemGyro = new AnalogGyro(0);
        driveSubsystemAccelerometer = new BuiltInAccelerometer(Range.k8G);

        driveSubsystemFrontLeftWheel = new DIOEncoderWheelController<>(driveSubsystemFrontLeftEncoder, DRIVE_SUBSYSTEM_WHEEL_SPEED_PID_CONSTANTS, new int[] { 3 }, driveSubsystemFrontLeftJaguar);
        SmartDashboard.putData("Front Left Wheel", driveSubsystemFrontLeftWheel);
        driveSubsystemFrontRightWheel = new DIOEncoderWheelController<>(driveSubsystemFrontRightEncoder, DRIVE_SUBSYSTEM_WHEEL_SPEED_PID_CONSTANTS, new int[] { 2 }, driveSubsystemFrontRightJaguar);
        SmartDashboard.putData("Front Right Wheel", driveSubsystemFrontRightWheel);
        driveSubsystemRearLeftWheel = new DIOEncoderWheelController<>(driveSubsystemRearLeftEncoder, DRIVE_SUBSYSTEM_WHEEL_SPEED_PID_CONSTANTS, new int[] { 12 }, driveSubsystemRearLeftJaguar);
        SmartDashboard.putData("Rear Left Wheel", driveSubsystemRearLeftWheel);
        driveSubsystemRearRightWheel = new DIOEncoderWheelController<>(driveSubsystemRearRightEncoder, DRIVE_SUBSYSTEM_WHEEL_SPEED_PID_CONSTANTS, new int[] { 13 }, driveSubsystemRearRightJaguar);
