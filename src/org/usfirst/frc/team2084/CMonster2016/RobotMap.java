...
public class RobotMap {
     ...
     * heading.
     */
    public static final double DRIVE_SUBSYSTEM_HEADING_TOLERANCE = 0.07;
    ...
    public static PIDConstants driveSubsystemRotationPIDConstants = new PIDConstants(2.75, 0, 4);

    public static double driveSubsystemRotationPIDTolerance = 0.05;
    ...
    public static void init() {
        ...
        driveSubsystemArcadeDriveAlgorithm = new GyroArcadeDriveAlgorithm(driveSubsystemDriveController,
                driveSubsystemGyro, driveSubsystemRotationPIDConstants, driveSubsystemRotationPIDTolerance);
