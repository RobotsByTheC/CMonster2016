...
import org.usfirst.frc.team2084.CMonster2016.commands.ManualArmControl;
...
public class ArmSubsystem extends Subsystem {
    ...
    public ArmSubsystem() {
        ...
        SmartDashboard.putData("Left Arm Talon", leftTalon);
        SmartDashboard.putData("Right Arm Talon", rightTalon);
    ...
    public void setAngle(double angle) {
        ...
        averageError.newValue(Math.abs(getAngle() - angle));
    ...
    public double getError() {
        return revsToAngle((leftTalon.getError() + rightTalon.getError()) / 2);
    }
