 ...
 */
public class ArcadeDriveAlgorithm extends DriveAlgorithm<DriveController<WheelController>> {
	 ...
	 */
	public ArcadeDriveAlgorithm(DriveController<WheelController> controller) {
		super(controller);
	}
