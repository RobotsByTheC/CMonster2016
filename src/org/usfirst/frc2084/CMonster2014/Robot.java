...
//        Robot.driveSubsystem.getRobotDrive().resetGyro();
        ...
        if (alliance.value == Alliance.kBlue_val) {
            Robot.ledSubsystem.sendCode(LedSubsystem.BLINK_BLUE_CODE);
        } else if (alliance.value == Alliance.kRed_val) {
            Robot.ledSubsystem.sendCode(LedSubsystem.BLINK_RED_CODE);
        } else {
            Robot.ledSubsystem.sendCode(LedSubsystem.BLINK_GREEN_CODE);
        }
    }
    ...
    public void disabledInit() {
        Robot.ledSubsystem.sendCode(LedSubsystem.PULSE_GREEN_CODE);
    }
