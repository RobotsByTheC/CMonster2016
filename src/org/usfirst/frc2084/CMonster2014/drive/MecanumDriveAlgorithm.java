...
public class MecanumDriveAlgorithm extends DriveAlgorithm {
    ...
    /**
     * The {@link GyroMecanumDriveAlgorithm} requires a
    ...
    public MecanumDriveAlgorithm(FourWheelDriveController controller) {
        super(controller);

        // Necessary because we hide the controller field inherited from
        // DriveAlgorithm (if this was >=Java 5 I would use generics [can't wait
        // for the RoboRIO!]).
