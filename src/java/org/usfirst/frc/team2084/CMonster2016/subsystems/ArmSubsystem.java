...
public class ArmSubsystem extends Subsystem {
    ...
    public static final double ANGLE_TOLERANCE = Math.toRadians(0.6);
    ...
    public static final PIDConstants ARM_PID_CONSTANTS = new PIDConstants(0.02, 0.0001, 0);
    public static final int ARM_I_ZONE = 20000;

    public static final String ARM_ANGLE_KEY = "Arm Angle";
    ...
    public double getSavedArmAngle() {
        return Preferences.getInstance().getDouble(ARM_ANGLE_PREFERNCE, Math.toRadians(65));
    }
