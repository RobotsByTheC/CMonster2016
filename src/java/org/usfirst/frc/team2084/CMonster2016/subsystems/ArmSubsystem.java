...
public class ArmSubsystem extends Subsystem {
    ...
    public static final double ANGLE_TOLERANCE = Math.toRadians(0.4);
    ...
    public ArmSubsystem() {
        ...
        sdTable.putNumber(ARM_ANGLE_KEY, Math.toDegrees(getAngle()));
        sdTable.setPersistent(ARM_ANGLE_KEY);
